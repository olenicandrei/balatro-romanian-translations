...
function Game:set_language()
    if not self.LANGUAGES then 
        ...
        self.LANGUAGES = {
            ...
            ['ro'] = {font = 1, label = "Română", key = 'ro', omit = false, beta = nil, button = "Feedback Traducere", warning = {'This language is still in Beta. To help us','improve it, please click on the feedback button.', 'Click again to confirm'}},
